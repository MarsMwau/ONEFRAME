...
const OAuth = () => {
  ...
  const handleGoogleClick = async () => {
    ...
    try {
      ...
      console.log("✅ Popup Success! User:", user.email);
  ...
  const handleBackendLogin = async (idToken) => {
    try {
        const response = await fetch("https://oneframe-api.onrender.com/api/auth/google-login", {
            method: "POST",
        ...
        alert("Server is slow or down. Please try again.");
        setIsLoading(false);
    }
  };
